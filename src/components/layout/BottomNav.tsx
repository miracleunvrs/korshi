...
export default function BottomNav() {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 z-40 bg-white/90 backdrop-blur-xl border-t border-gray-100/80 px-4 py-2">
          ...
          if (item.isCreate) {
            return (
              <Link
                key={item.href}
                href={item.href}
                className="relative -top-5 w-13 h-13 bg-gradient-to-tr from-green-600 to-emerald-500 rounded-full flex items-center justify-center text-white shadow-xl shadow-green-600/40 hover:shadow-green-600/60 active:scale-90 transition-all duration-200 ring-4 ring-white"
