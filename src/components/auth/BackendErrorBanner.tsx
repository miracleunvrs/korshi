...
export default function BackendErrorBanner() {
  ...
  return (
    <div className="fixed left-4 right-4 top-4 z-[100] mx-auto flex max-w-xl items-start justify-between gap-3 rounded-2xl border border-red-200 bg-red-50 p-3 text-xs text-red-800 shadow-lg">
