...
|------|-----|--------------|
| Primary | `#166534` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#7C3AED` | `--color-secondary` |
| Accent/CTA | `#16A34A` | `--color-accent` |
| Background | `#F8F7F2` | `--color-background` |
| Foreground | `#1C1917` | `--color-foreground` |
| Muted | `#F0EEEA` | `--color-muted` |
| Border | `#E4E0DB` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#166534` | `--color-ring` |

**Color Notes:** Accessible pine anchors trusted household operations; violet distinguishes community creation actions; warm stone surfaces avoid a generic social-network feel.

### Typography

- **Heading Font:** Manrope
- **Body Font:** Manrope
- **Mood:** warm, trustworthy, contemporary, legible Cyrillic, civic without bureaucracy
